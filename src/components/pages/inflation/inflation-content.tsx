...
import { DollarSign, TrendingUp, TrendingDown, Info, Fuel, Home, Utensils, Stethoscope, GraduationCap, Car, Sparkles } from "lucide-react";
...
export function InflationContent() {
  ...
  return (
    <PageLayout
      ...
      actions={
        <div className="flex items-center gap-2">
          ...
          />
          <PrintButton />
          <FavoriteButton seriesId="CPIAUCSL" />
    ...
    >
      ...
      <ContextBanner seriesId="CPIAUCSL" className="mb-6" />
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-3">
        ...
        <AIInsight
          ...
          currentValue={cpi.latestValue}
          change={cpi.yoyChange}
          className="lg:col-span-2"
        />

        {/* Related Indicators */}
        <IndicatorRelationships seriesId="CPIAUCSL" />
      </div>
